...
<div class="container" id="navbar">
	...
	<li id="b2" class="a0"><a class="navlink" href="viewAccepted.php">Accepted Reservations</a></li>
...
else if($_SESSION['SESS_ISADMIN'] == 0)
{
	...
	echo "<h2 align=\"center\" style=\"color:rgb(0,133,63)\">Accepted Reservations</h2>";	
